...
# TEST KINT MODELIS:
mod_sp350 = lm( SP350 ~ lag(kk,0) + lag(kk,13) + lag(dll,1) + lag(nedarbas,0) + lag(mhope,0) + lag(phope,1) + lag(pramhope,2) + lag(shope,8) + lag(ul,1) + lag(vhope,2) + lag(vp,0) + lag(mp,4) + lag(gkl,5) + lag(ip,13)  + lag(kursas,0), data=data3)
# ccf: kursas - 0.597; 
...
```{r, + mazmenines prekybos pasitikejimas,  0.013390->0.012702}
# KORELIACIJA:
names2=c("SP350","SP500","kk","dll","nedarbas","infliacija","mhope","phope","pramhope","shope","ta","ul","vhope","vp","mp","palukanos","gkl","ip","kursas")
...
```{r, +- paslaugu pasitikejimas, 0.052423->0.09776}
# KORELIACIJA:
names2=c("SP350","SP500","kk","dll","nedarbas","infliacija","mhope","phope","pramhope","shope","ta","ul","vhope","vp","mp","palukanos","gkl","ip","kursas")
...
```{r, + pramones pasitikejimas, 0.107637->0.04886}
# KORELIACIJA:
names2=c("SP350","SP500","kk","dll","nedarbas","infliacija","mhope","phope","pramhope","shope","ta","ul","vhope","vp","mp","palukanos","gkl","ip","kursas")
...
```{r, + uzsakimu lukesciai,  0.007905->0.01669}
# KORELIACIJA:
names2=c("SP350","SP500","kk","dll","nedarbas","infliacija","mhope","phope","pramhope","shope","ta","ul","vhope","vp","mp","palukanos","gkl","ip","kursas")
...
```{r, ++ gamintoju kainu lygis,  0.000174->0.00331}
# KORELIACIJA:
names2=c("SP350","SP500","kk","dll","nedarbas","infliacija","mhope","phope","pramhope","shope","ta","ul","vhope","vp","mp","palukanos","gkl","ip","kursas")
...
```{r, +- industrine produkcija,  0.127604->0.142865}
# KORELIACIJA:
names2=c("SP350","SP500","kk","dll","nedarbas","infliacija","mhope","phope","pramhope","shope","ta","ul","vhope","vp","mp","palukanos","gkl","ip","kursas")
