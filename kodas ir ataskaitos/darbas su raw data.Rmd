...
data2[,c("OMX","SP350","SP500","kursas","kk","mp","gkl","ip")] = apply(data2[,c("OMX","SP350","SP500","kursas","kk","mp","gkl","ip")],1,log)        
#logaritmuojant atsiranda NA del neigiamo skaiciaus

data3=data.frame(diff(as.matrix(data2)))
diffeile = data.frame(sapply(data3,ndiffs))
