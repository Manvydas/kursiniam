...
plot(ts, type="l", main="OMX Vilnius", xlab="Metai", ylab="Verte"); lines(ts_m, col="red", lwd=2); lines(ts_m2, col="blue", lwd=1.5)
legend("bottomright", legend=c("Pagal vidurki", "Pagal paskutinia diena"), col=c("red", "blue"), lwd=c(2,1.5), cex=0.75)
```
